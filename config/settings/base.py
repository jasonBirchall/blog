...
# When true, every response is marked noindex/nofollow (preview env only).
IS_PREVIEW = env_bool("DJANGO_PREVIEW")
...
MIDDLEWARE = [
    ...
    # WhiteNoise serves static files; it must sit directly after SecurityMiddleware.
